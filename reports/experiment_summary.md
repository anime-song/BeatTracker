...
Generated: 2026-03-22 12:14:29 UTC
...
| beat_transcription_with_boundary | complete | 16 | 0.5672 | 30 | 0.5500 | 42 | 0.000300 | 8 | 0.050 | 0.100 | true | 4 | backbone:ema_state_dict | L6/H64/O256 | hop512-cqt |
| beat_transcription_hop512_pretrain | complete | 24 | 0.5471 | 30 | 0.5273 | 42 | 0.000300 | 8 | 0.050 | 0.100 | true | 4 | backbone:model_state_dict | L6/H64/O256 | hop512-cqt |
...
| exp_meter_from_rhythm_bilstm_w0_05_downbeatw1_5 | complete | 23 | 0.4502 | 30 | 0.4237 | 42 | 0.000300 | 8 | 0.050 | 0.100 | true | 4 | backbone:ema_state_dict | L6/H64/O256 | exp/meter-from-rhythm-bilstm |
...
| exp_meter_from_rhythm_hardpred_w0_01 | complete | 23 | 0.4463 | 30 | 0.4208 | 42 | 0.000300 | 8 | 0.050 | 0.100 | true | 4 | backbone:ema_state_dict | L6/H64/O256 | exp/meter-from-rhythm-bilstm |
...
| exp_meter_from_rhythm_bilstm_w0_05 | complete | 25 | 0.4431 | 30 | 0.4182 | 42 | 0.000300 | 8 | 0.050 | 0.100 | true | 4 | backbone:ema_state_dict | L6/H64/O256 | exp/meter-from-rhythm-bilstm |
...
| exp_meter_from_rhythm_bilstm_w0_05_balanced | complete | 20 | 0.4338 | 30 | 0.4143 | 42 | 0.000300 | 8 | 0.050 | 0.100 | true | 4 | backbone:ema_state_dict | L6/H64/O256 | exp/meter-from-rhythm-bilstm |
...
| from_ssl_pretrain | complete | 30 | 0.3605 | 30 | 0.3605 | 42 | 0.000300 | 8 | 0.050 | 0.100 | true | 4 | backbone:model_state_dict | L6/H64/O256 | exp/ssl-pretrain-plp |
...
| ssl_pretrain_hop512 | complete | - | - | 100 | - | 42 | 0.000300 | 8 | - | - | - | - | - | L6/H64/O256 | - |
...
## beat_transcription_with_boundary

| field | value |
| --- | --- |
| path | outputs/beat_transcription_with_boundary |
| status | complete |
| best_epoch | 16 |
| best_downbeat_f1 | 0.5672 |
| best_beat_f1 | 0.6886 |
| best_val_loss | 1.2282 |
| last_epoch | 30 |
| last_downbeat_f1 | 0.5500 |
| configured_epochs | 30 |
| seed | 42 |
| lr | 0.000300 |
| batch_size | 8 |
...
| resume | - |
| git_branch | hop512-cqt |
| git_commit | ba5b8ca5b190c9fff8cedf99d8fe179acec3cabe |
| git_dirty | true |

## beat_transcription_hop512_pretrain

| field | value |
| --- | --- |
| path | outputs/beat_transcription_hop512_pretrain |
| status | complete |
| best_epoch | 24 |
| best_downbeat_f1 | 0.5471 |
| best_beat_f1 | 0.7122 |
| best_val_loss | 1.3715 |
| last_epoch | 30 |
| last_downbeat_f1 | 0.5273 |
| configured_epochs | 30 |
| seed | 42 |
| lr | 0.000300 |
| batch_size | 8 |
...
| stem_dropout_max_count | 4 |
| init_scope | backbone |
| init_from | outputs/ssl_pretrain_hop512/checkpoint_last.pt |
...
| field | value |
| --- | --- |
| path | outputs/from_ssl_no_drum_constrastive_pretrain |
| status | complete |
| best_epoch | 19 |
| best_downbeat_f1 | 0.5093 |
| best_beat_f1 | 0.6492 |
| best_val_loss | 1.1811 |
| last_epoch | 30 |
| last_downbeat_f1 | 0.4765 |
| configured_epochs | 30 |
| seed | 42 |
| lr | 0.000300 |
| batch_size | 8 |
...
| stem_dropout_max_count | 4 |
| init_scope | backbone |
| init_from | outputs/ssl_no_drum_contrastive_pretrain/checkpoint_last.pt |
| init_state_source | model_state_dict |
| audio_backend | packed |
| scheduler | warmup_cosine |
| ema_decay | 0.9990 |
...
| git_commit | 204bb442596ce68b93d0362d3e7ebe68c3b868b3 |
| git_dirty | true |
...
| field | value |
| --- | --- |
| path | outputs/from_ssl_plp_with_chord_boundary |
| status | complete |
| best_epoch | 23 |
| best_downbeat_f1 | 0.4894 |
| best_beat_f1 | 0.6068 |
| best_val_loss | 1.2796 |
| last_epoch | 30 |
| last_downbeat_f1 | 0.4752 |
| configured_epochs | 30 |
| seed | 42 |
| lr | 0.000300 |
| batch_size | 8 |
...
| meter_loss_weight | 0.050 |
| drum_aux_loss_weight | 0.100 |
| drum_aux_use_high_frequency_flux | false |
| stem_dropout_max_count | 4 |
| init_scope | backbone |
| init_from | outputs/ssl_plp_pretrain/plp_with_chord_boundary/checkpoint_last.pt |
| init_state_source | model_state_dict |
| audio_backend | packed |
| scheduler | warmup_cosine |
| ema_decay | 0.9990 |
...
| resume | - |
| git_branch | exp/ssl-pretrain-plp |
| git_commit | 72986ef6a6e5e958f978d2c3bf7c8aa66587d9f5 |
| git_dirty | true |
...
## exp_meter_from_rhythm_bilstm_w0_05_downbeatw1_5

| field | value |
| --- | --- |
| path | outputs/exp_meter_from_rhythm_bilstm_w0_05_downbeatw1_5 |
| status | complete |
| best_epoch | 23 |
| best_downbeat_f1 | 0.4502 |
| best_beat_f1 | 0.6387 |
| best_val_loss | 1.4423 |
| last_epoch | 30 |
| last_downbeat_f1 | 0.4237 |
| configured_epochs | 30 |
| seed | 42 |
| lr | 0.000300 |
| batch_size | 8 |
...
| model | L6/H64/O256 |
| resume | - |
| git_branch | exp/meter-from-rhythm-bilstm |
| git_commit | c28e23288e21e6a81b365d19dea8a1e86b8b062a |
| git_dirty | true |
...
## exp_meter_from_rhythm_hardpred_w0_01

| field | value |
| --- | --- |
| path | outputs/exp_meter_from_rhythm_hardpred_w0_01 |
| status | complete |
| best_epoch | 23 |
| best_downbeat_f1 | 0.4463 |
| best_beat_f1 | 0.6453 |
| best_val_loss | 1.5092 |
| last_epoch | 30 |
| last_downbeat_f1 | 0.4208 |
| configured_epochs | 30 |
| seed | 42 |
| lr | 0.000300 |
| batch_size | 8 |
...
| resume | - |
| git_branch | exp/meter-from-rhythm-bilstm |
| git_commit | 1c193a8b2d9891eb4b430e81b2683a4a33234b72 |
| git_dirty | true |
...
## exp_meter_from_rhythm_bilstm_w0_05

| field | value |
| --- | --- |
| path | outputs/exp_meter_from_rhythm_bilstm_w0_05 |
| status | complete |
| best_epoch | 25 |
| best_downbeat_f1 | 0.4431 |
| best_beat_f1 | 0.6601 |
| best_val_loss | 1.3691 |
| last_epoch | 30 |
| last_downbeat_f1 | 0.4182 |
| configured_epochs | 30 |
| seed | 42 |
| lr | 0.000300 |
| batch_size | 8 |
...
## exp_meter_from_rhythm_bilstm_w0_05_balanced

| field | value |
| --- | --- |
| path | outputs/exp_meter_from_rhythm_bilstm_w0_05_balanced |
| status | complete |
| best_epoch | 20 |
| best_downbeat_f1 | 0.4338 |
| best_beat_f1 | 0.6684 |
| best_val_loss | 1.3445 |
| last_epoch | 30 |
| last_downbeat_f1 | 0.4143 |
| configured_epochs | 30 |
| seed | 42 |
| lr | 0.000300 |
| batch_size | 8 |
...
| resume | - |
| git_branch | exp/meter-from-rhythm-bilstm |
| git_commit | 4230a08bb80585f4d9665fe8a313dbd74536ac26 |
| git_dirty | true |
...
| field | value |
| --- | --- |
| path | outputs/from_ssl_pretrain |
| status | complete |
| best_epoch | 30 |
| best_downbeat_f1 | 0.3605 |
| best_beat_f1 | 0.5938 |
| best_val_loss | 1.0557 |
| last_epoch | 30 |
| last_downbeat_f1 | 0.3605 |
| configured_epochs | 30 |
| seed | 42 |
| lr | 0.000300 |
| batch_size | 8 |
...
| stem_dropout_max_count | 4 |
| init_scope | backbone |
| init_from | outputs/ssl_plp_pretrain/plp_init_from_chord/checkpoint_last.pt |
| init_state_source | model_state_dict |
| audio_backend | packed |
| scheduler | warmup_cosine |
| ema_decay | 0.9990 |
...
| resume | - |
| git_branch | exp/ssl-pretrain-plp |
| git_commit | 44c9b888ce0adf7b1540b1417f4e86ca196198b4 |
| git_dirty | true |
...
| field | value |
| --- | --- |
| path | outputs/ssl_pretrain_hop512 |
| status | complete |
| best_epoch | - |
| best_downbeat_f1 | - |
| best_beat_f1 | - |
...
| field | value |
| --- | --- |
| path | outputs/ssl_no_drum_contrastive_pretrain |
| status | complete |
| best_epoch | - |
| best_downbeat_f1 | - |
| best_beat_f1 | - |
