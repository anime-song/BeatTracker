...
Generated: 2026-03-13 11:46:57 UTC

Runs: 9

| run | status | best_epoch | best_downbeat_f1 | last_epoch | last_downbeat_f1 | seed | lr | batch | meter_w | meter_cond | model | branch |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| exp_meter_downbeat_conditioning_w0_05 | complete | 18 | 0.3248 | 30 | 0.3090 | 42 | 0.000300 | 8 | 0.050 | downbeat_additive | L6/H64/O256 | exp/meter-downbeat-conditioning |
...
| segment_seconds | 30.0 |
| meter_loss_weight | 0.050 |
| meter_conditioning | downbeat_additive |
| audio_backend | packed |
| scheduler | warmup_cosine |
| ema_decay | 0.9990 |
| model | L6/H64/O256 |
