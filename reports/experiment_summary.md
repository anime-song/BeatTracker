...
Generated: 2026-03-13 09:17:46 UTC

Runs: 8

| run | status | best_epoch | best_downbeat_f1 | last_epoch | last_downbeat_f1 | seed | lr | batch | meter_mode | meter_head | meter_w | model | branch |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| exp_meter_context_lowres_w0_05 | complete | 22 | 0.3382 | 30 | 0.3158 | 42 | 0.000300 | 8 | full | context_lowres | 0.050 | L6/H64/O256 | exp/meter-context-lowres |
...
| meter_head_source | context_lowres |
| meter_loss_weight | 0.050 |
| audio_backend | packed |
| scheduler | warmup_cosine |
| ema_decay | 0.9990 |
