...
class ExperimentSummary:
    ...
    spec_augment_freq_mask_rate: Optional[float]
    spec_augment_time_mask_rate: Optional[float]
    ...
    def to_csv_row(self) -> dict[str, str]:
        return {
            ...
            "spec_augment_freq_mask_rate": _format_float(
                self.spec_augment_freq_mask_rate, digits=3
            ),
            "spec_augment_time_mask_rate": _format_float(
                self.spec_augment_time_mask_rate, digits=3
            ),
...
def _build_summary(run_dir: Path) -> Optional[ExperimentSummary]:
    ...
    return ExperimentSummary(
        ...
        spec_augment_freq_mask_rate=_as_float(config.get("spec_augment_freq_mask_rate")),
        spec_augment_time_mask_rate=_as_float(config.get("spec_augment_time_mask_rate")),
...
def write_markdown(markdown_path: Path, summaries: list[ExperimentSummary]) -> None:
    ...
    overview_rows = [
        [
            ...
            _format_float(summary.spec_augment_freq_mask_rate, digits=3) or "-",
            _format_float(summary.spec_augment_time_mask_rate, digits=3) or "-",
            summary.model_tag,
            ...
            [
                ...
                _markdown_table(
                    ...
                    [
                        ...
                        [
                            "spec_augment_freq_mask_rate",
                            _format_float(summary.spec_augment_freq_mask_rate, digits=3)
                            or "-",
                        ],
                        [
                            "spec_augment_time_mask_rate",
                            _format_float(summary.spec_augment_time_mask_rate, digits=3)
                            or "-",
                        ],
