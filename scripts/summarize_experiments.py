...
class ExperimentSummary:
    ...
    meter_balanced_softmax_tau: Optional[float]
    ...
    def to_csv_row(self) -> dict[str, str]:
        return {
            ...
            "meter_balanced_softmax_tau": _format_float(
                self.meter_balanced_softmax_tau, digits=3
            ),
...
def _build_summary(run_dir: Path) -> Optional[ExperimentSummary]:
    ...
    return ExperimentSummary(
        ...
        meter_balanced_softmax_tau=_as_float(
            config.get("meter_balanced_softmax_tau")
        ),
...
def write_markdown(markdown_path: Path, summaries: list[ExperimentSummary]) -> None:
    ...
    overview_rows = [
        [
            ...
            _format_float(summary.meter_balanced_softmax_tau, digits=3) or "-",
            (
                summary.init_scope
                ...
                _markdown_table(
                    ...
                    [
                        ...
                        [
                            "meter_balanced_softmax_tau",
                            _format_float(
                                summary.meter_balanced_softmax_tau, digits=3
                            )
                            or "-",
                        ],
