...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="packed 化に成功した、または既存 packed を検証できた元の stem WAV を削除します。",
    )
    parser.add_argument(
        "--sample-rate",
        type=int,
...
def main() -> None:
    ...
    print(
        f"packed={packed_count}, skipped={skipped_count}, "
        f"deleted_stem_files={deleted_stem_count}, packed_size={packed_size_mib:.1f} MiB"
    )
